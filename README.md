...
**1. Necessity over wants.**
Every subsystem was considered, crafted, and implemented with a purpose. Nothing was built because the technology existed or the pattern was fashionable. The test is always: does this reduce a real risk — or does it solve a problem we deliberately designed away?

**2. Organic craft over commodity architecture.**
The Biosphere grew. It was not assembled from templates. Containerisation, cloud-native abstractions, and microservice orthodoxy are answers to problems this system does not have. Imposing them would be rearchitecting three years of deliberate work to fit a pattern designed for a different purpose entirely.

**3. Local resilience over portability.**
Stabilisation and resilience on this host matter more than the ability to deploy elsewhere. If a client SLA one day demands uptime this host cannot provide, the answer is a second machine with replicated state — not Docker. Migration for preservation, not portability for productisation.
